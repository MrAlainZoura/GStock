        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white" id="textEditeDevise">
                    Télécharger le rapport d'une année
                </h3>
            ...
            <div class="p-4 md:p-5">
                <div class="space-y-4">
                   ...
                   <div class="grid gap-4 grid-cols-1 sm:grid-cols-1">
                     <div>
                         <label for="annee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Renseigner l'année</label>
                     ...
                     <!-- <div>
                         ...
                         <input type="text" name="lonM" id="lon0" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                     </div> -->
                   </div>
