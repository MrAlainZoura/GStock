        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{route($action)}}" method="post">
                    ...
                    @method('post')
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Libellé {{$libele}}</label>
                    ...
                    <div class="">
                        <label for="taux" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Taux d'échange</label>
                    ...
                    <div class="hidden">
                        ...
                        <input type="text" name="user_id" id="password" value="{{$user_id}}" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  />
                    </div>
