...
@section('main')  
    ...
    <section class="p-10 gap-5 w-full">
        ...
        <div class="flex justify-end m-5">
            <a href="{{route('rapportDownload',['depot'=>$depot->id*12, 'periode'=>'annee', 'table'=>'presence'])}}" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Télécharger PDF
