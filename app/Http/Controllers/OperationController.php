...
class OperationController extends Controller
{
    ...
    public function transfert(Request $request)
    {
        ...
        $verifStockDispo = Operation::where('depot_id', $request->depot_id)
            ->where('produit_id',$request->produit_id)
            ->where('libele','approvionnement')->get();

        $verifStockSorti = Operation::where('depot_id', $request->depot_id)
            ->where('produit_id',$request->produit_id)
            ->where('libele','transfert')->get();

        $verifStockVente = Operation::where('depot_id', $request->depot_id)
            ->where('produit_id',$request->produit_id)
            ->where('libele','vente')->get();
